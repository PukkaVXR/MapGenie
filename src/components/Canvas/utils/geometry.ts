...
export function getTerritoryCenter(territory: any) {
...
// Get territory edges
export function getTerritoryEdges(territory: any): { x1: number; y1: number; x2: number; y2: number }[] {
...
// Find nearest edge
export function findNearestEdge(territories: any, point: { x: number; y: number }, snapDistance: number = 10) {
